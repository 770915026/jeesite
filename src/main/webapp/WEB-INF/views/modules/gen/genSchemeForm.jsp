...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a
			href="${ctx}/gen/genScheme/form?id=${genScheme.id}">生成方案${not empty genScheme.id?'修改':'添加'}<shiro:lacksPermission
	...
	<form:form id="inputForm" modelAttribute="genScheme"
		...
		<div class="form-actions">
			...
			<input id="btnSubmit" class="btn btn-primary" type="submit"
				value="保存方案" onclick="$('#flag').val('0');" />&nbsp; <input
				id="btnSubmit" class="btn btn-danger" type="submit" value="保存并生成代码"
				onclick="$('#flag').val('1');" />&nbsp; <input id="btnCancel"
