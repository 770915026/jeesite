...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="taier:tlSysAgreement:edit">
			<li><a href="${ctx}/taier/tlSysAgreement/form">协议添加</a></li>
		</shiro:hasPermission>
	</ul>
				...
				<tr>
					<shiro:hasPermission name="taier:tlSysAgreement:edit">
						<td><a
							...
							<a
							href="${ctx}/taier/tlSysAgreement/delete?id=${tlSysAgreement.id}"
							onclick="return confirmx('确认要删除该协议吗？', this.href)">删除</a></td>
					</shiro:hasPermission>
				</tr>
			</c:forEach>
		</tbody>
