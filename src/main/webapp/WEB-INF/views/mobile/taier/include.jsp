...
<link rel="stylesheet" type="text/css"
	href="${ctxStatic}/newtaiermobile/css/style.css">
<script type="text/javascript"
	src="${ctxStatic}/newtaiermobile/js/c.base.js"></script>
<script type="text/javascript"
	src="${ctxStatic}/newtaiermobile/js/c.jquery1.8.3.min.js"></script>
<script type="text/javascript"
...
<script>
    ...
    $(function(){
        $.ajax({
            url: "${contextPath}/taier/jump/getLinks",
            type:"post",
            dataType:"json",
            success: function (data){
                $("#linksli").html("");
                if(data.code==200){
                    var hotNewsListStr="";
                    var linklist=data.hashMap.linkList;
                    if(linklist && linklist.length>0){
                        for(var i=0;i<linklist.length;i++){
                            hotNewsListStr+='<a href="'+linklist[i].linkUrl+'" target="_blank">'+linklist[i].title+'<em>|</em></a>';
                        }
                        $("#linksli").append(hotNewsListStr);
                    }else{
                    }
                }
        ...
        $(".login-home-nav").click(function(){
            $(".main-menu-wrap").show();
        })

        $(".zcdiv").click(function(){
            var node=$('.main-menu-wrap');
            if(!node.is(':hidden')){
                node.hide();
            }
        })
...
<div class="main-menu-wrap" style="display: none;">
	<ul class="menu-conent">
		<li><a href="${contextPath}/taier/jump/gotoFirstPage">首页</a></li>
		<li><a href="${contextPath}/taier/jump/gotoNews">动态新闻</a></li>
		<li><a href="javascript:;">业务办理</a>
			<div class="list02">
				<a href="${ctx}/taier/theNet/gotoCCC">CCC业务</a> <a
					href="${ctx}/taier/theNet/gotoTheNet;">进网业务</a> <a
					href="javascript:;">国内业务</a> <a href="javascript:;">网站业务</a>
			</div></li>
		<li><a href="${contextPath}/taier/jump/gotoTaierauth">泰尔证书</a></li>
		<li><a href="${contextPath}/taier/jump/unionInfoListUSer">信息发布</a>
		</li>
		<li><a href="${contextPath}/taier/jump/preSetAppListUSer">预置APP公示</a>
		</li>
		<li><a
			href="${contextPath}/taier/analysisReportFront/gotoAnalysisReport">行业分析报告</a>
		</li>
		<li class="list"><span><a
				href="${contextPath}/taier/activityFront/gotoActivity">小泰说</a></span> <span><a
				href="${contextPath}/taier/policyFront/gotoPolicy;">政策</a></span> <span
			class="border-none"><a
				href="${contextPath}/taier/jump/gotoAboutUs">关于我们</a></span> <span
			class="border-none"><a
				href="${contextPath}/taier/jump/gotoConnectUs">联系我们</a></span></li>
	</ul>
</div>