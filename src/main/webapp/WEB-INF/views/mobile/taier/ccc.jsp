...
<body>
											...
											<table class=buyTitle datasrc='#ds12' datafld='LTEFDD'>
												<tr>
													<td style="border: none;">LTE FDD: <INPUT
														...
														datafld='cBand3'
														onclick="refCheckChange(this,'af_12_LTEFDD__SHOW__')">Band
														3 <INPUT type=checkbox id=af_12_LTEFDD
														name="tmcSbjjb.ltefdd" value=Band5
														${fn:contains(tmcRwsqd.tmcSbjjb.ltefdd, 'Band5')?'checked':''}
														datafld='cBand5'
														onclick="refCheckChange(this,'af_12_LTEFDD__SHOW__')">Band
														5
							...
							<div class="" id="cf7" style="display: none;">
								<div id='xz_div' style='width: 100%; text-align: center'>
									<div style="width: 100%; padding: 1px 1px 1px 1px"
										...
										<div style="width: 100%;">
											<input type="hidden" name="tmcBgqrb.pk1"
												value="${tmcRwsqd.tmcBgqrb.pk1 }">
    ...
    function addaqj(){
        ...
        $("#aqjtdy").append('<tr>' +
            '<td><input style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].xh"></td>' +
            '<td><input style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].wh"></td>' +
            '<td><input style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].bjh"></td>' +
            '<td><input style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].mc"></td>' +
            '<td><input style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].xh"></td>' +
            '<td><textarea style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].clygg"></textarea></td>' +
            '<td><textarea style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].zzs"></textarea></td>' +
            '<td><textarea style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].scc"></textarea></td>' +
            '<td><input style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].rzxx"></td>' +
            '<td><textarea style="width: 100%;margin-left: 0px !important;border: 0px;" type="text" name="aqyqjlbList['+aqjnum+'].bz"></textarea></td>' +
    ...
    function submitTocheck(){
    	window.location.href="${ctx}/taier/tmcRwsqd/updateStatus?pk1=${tmcRwsqd.pk1}&type=1&status=1";
    }
</script>
</body>
