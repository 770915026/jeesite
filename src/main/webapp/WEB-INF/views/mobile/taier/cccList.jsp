...
<body>
	...
	<section class="qiye_cont w1200">
		...
		<div class="qiye_right">
			<h3>
				<i class="icon iconfont icon-arrfill_u-copy"></i>CCC
			</h3>
        ...
        $.ajax({
            ...
            success:function(msg){
                ...
                $.each(msg.list,function(i,info){
                	...
                	if(status=="0"){
                		status="已保存";
                		operate+='<a style="color:#2fa4e7;" href="${ctx}/taier/tmcRwsqd/viewCCC?pk1='+info.pk1+'&bh='+info.bh+'">编辑提交</a>&nbsp;';
                	}
                	if(status=="1"){
                		status="已提交";
                	}
