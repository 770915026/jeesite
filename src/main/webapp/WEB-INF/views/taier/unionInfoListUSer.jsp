            ...
            if(code == 200) {
            	...
            	if(list){
            		for(var i=0;i<list.length;i++) {
                       ...
                       '     <a href="${contextPath}/taier/jump/unionInfoDetailUSer?id='+list[i].id+'&type=5&pp='+pp+'&nc='+nc+'&cc='+cc+'">    '+
                       '     <span class="img-box">'+
                       '     <img src="'+img+'">                      '+
                       '     </span>                                          '+
                       '     <p class="list-text" style="text-align: center;">'+list[i].productName+'<br/>'+list[i].productVersion+'</p>'+
                       ' </a>'+
                       ' <div class="certificate-intro">'+
                       '     <a class="links" style="margin-left: 20px;" href="${contextPath}/taier/jump/unionInfoDetailUSer?id='+list[i].id+'&type=2&pp='+pp+'&nc='+nc+'&cc='+cc+'">国内证书</a>'+
                       '     <a class="links" href="${contextPath}/taier/jump/unionInfoDetailUSer?id='+list[i].id+'&type=5&pp='+pp+'&nc='+nc+'&cc='+cc+'">配置信息</a>'+
                       '     <a class="links" style="margin-left: 20px;" href="${contextPath}/taier/jump/unionInfoDetailUSer?id='+list[i].id+'&type=1&pp='+pp+'&nc='+nc+'&cc='+cc+'">产品介绍</a>'+
                       '     <a class="links" href="${contextPath}/taier/jump/unionInfoDetailUSer?id='+list[i].id+'&type=4&pp='+pp+'&nc='+nc+'&cc='+cc+'">泰尔证书</a>'+
                       '     </div>'+
                       '    </dd>');
                    }
            	}
