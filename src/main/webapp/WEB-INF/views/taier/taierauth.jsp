...
<link rel="stylesheet" type="text/css"
	href="${ctxStatic}/newtaier/css/certificateShow.css">
...
<body>
	...
	<div class="container" style="padding-left: 0px; padding-right: 0px;">
		...
		<div class="taier-certificate-header">
			<div class="taier-container">
				<span class="title">泰尔证书展示</span> <span class="search-input">
					<input class="input" type="" id="zssearch" name="zssearch"
					placeholder="证书信息搜索"> <a class="search" href="javascript:;"
					onclick="searchtaizs()"></a>
				</span>
			</div>
		</div>
		...
		<div class="taier-container">
			<!--导航-->
			<div class="taier-container-nav">
				<span> <a href="${contextPath}/taier/jump/gotoFirstPage">首页
						></a>
				</span> <span> <a href="${contextPath}/taier/jump/gotoAboutUs">关于我们
						></a>
				</span> <span> <a href="${contextPath}/taier/jump/gotoTaierauth">泰尔证书展示</a>
				</span>
			</div>
			<!--导航 end-->
			<!--证书列表-->
			<div class="taier-list-box">
				<div class="taier-list">
					<dl id="zsdiv">
						<c:forEach items="${certificateShowList }" var="certificateShow">
							<dd>
								<a href="javascript:;"> <img src="${certificateShow.img}">
									<p>${certificateShow.name}</p>
								</a>
							</dd>
						</c:forEach>
