...
<body>
	...
	<section class="qiye_cont w1200">
		...
		<ul class="nav nav-tabs">
			<li><a href="${ctx}/taier/tlCompanyUnionInfo/"
				style="color: #2fa4e7">企业联合信息列表</a></li>
			<li class="active"><a
		...
		<div class="qiye_right operation_box" id="operation_box">
			...
			<table class="qiye_table table table-bordered">
				<tr>
					<td>企业</td>
					<td><select name="companyList"
						style="border: 1px solid #ddd; width: 120px;">
				...
				<tr>
						...
						value="0" checked>图文描述<br> <span class="pzxxtw">
							<div href="javascript:;" class="appli_file pei_input">
								...
								<a class="dela" style="display: none;" onclick="delimg(this)"
									...
									name="filevl">
							</div> <!-- <input type="text" class="pzxxbt" placeholder=""  style="margin-top: 15px;" class="appli_text">
                        <textarea class="appli_text appli_text1"></textarea> -->
							<div style="padding-top: 10px">
					...
					</span> <br> <a href="javascript:void(0);" class="add_appli1">添加</a><br>
						<input type="radio" class="paper" name="a" value="1">文字描述<br>
				...
				<tr>
					...
					<td class="gnrz"><span><div href="javascript:;"
							...
							</div> </span> <a href="javascript:void(0);" class="add_appli2">添加</a></td>
				</tr>
				...
				<tr>
					...
					<td class="terz"><span><div href="javascript:;"
								...
								<a class="dela" style="display: none;" onclick="delimg(this)"
									...
									onchange="uploadImg(this)"> <input type="hidden"
									name="filevl">
							</div> <textarea class="appli_text"></textarea> </span> <a
						href="javascript:void(0);" class="add_appli">添加</a></td>
				</tr>
			</table>
			<p class="table_btn">
    ...
    $(function(){
        ...
        clonetable = '<div class="qiye_right operation_box" style="margin-right: 16px;">'+$("#operation_box").html()+"</div>";
    })
    ...
    function save(obj){
        ...
        companyId=table.find("select[name=companyList] option:selected").val();
        //产品名称
        ...
        orderNo=table.find("input[name=orderNo]").val();
        //产品照片
        ...
        ajax("${ctx}/taier/tlCompanyUnionInfo/save" , data , function(result){
            ...
            if(code == 200) {
                alert("保存成功");
                window.location.href="${ctx}/taier/tlCompanyUnionInfo/";
            } else {
                alert("保存失败");
            }
        });
