...
<script>
        ...
        function showyltb(obj, idx){
            ...
            $("#cf1").hide();$("#cf2").hide();$("#cf3").hide();$("#cf4").hide();
            $("#cf"+idx).show();
...
<body>
						...
						<div>
							<div class="" id="cf1">
								<input type="hidden" id="pk1" name="pk1"
									...
									id="type" name="type" value="1"> <input type="hidden"
    ...
    function initValue(){
    	/* $("#af_1_BGLX").val('${tmcRwsqd.bglx }');
    	$("#af_1_JCLB").val('${tmcRwsqd.jclb }') */
    }
...
//							'<input type="hidden" name="tmcBbxzList['+filenum+'].wjlj" value="'+e.fileUrl+'"></TD>\n' +
    ...
    function MyTjsss(){
//        if(document.getElementById('af_1_SJDW').value==''){
//            alert("受检单位地址");
//            return;
//        }
//        if(document.getElementById('af_1_SCC').value==''){
//            alert("生产厂");
//            return;
//        }
//        if(document.getElementById('af_1_LXRMC').value==''){
//            alert("联系人");
//            return;
//        }
//        if(document.getElementById('af_1_YDDH').value==''){
//            alert("移动电话");
//            return;
//        }
//        if(document.getElementById('af_1_SBXH').value==''){
//            alert("设备型号");
//            return;
//        }
//        if(document.getElementById('af_1_SBMC').value==''){
//            alert("设备名称");
//            return;
//        }
//
//        if(document.getElementById('af_1_SBJC').value==''){
//            alert("设备简称");
//            return;
//        }
//
//        if(document.getElementById('af_1_JCLB').value==''){
//            alert("检测类别");
//            return;
//        }
//        if(document.getElementById('af_1_SFBM').value==''){
//            alert("任务类型");
//            return;
//        }
