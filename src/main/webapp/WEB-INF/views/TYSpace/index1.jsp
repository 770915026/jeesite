...
<head>
    ...
    <title>监控系统</title>
    <link rel="stylesheet" href="${ctxStatic}/spacety/css/style.css">
    <script src="${ctxStatic}/spacety/js/jquery.min.js"></script>
    <script src="${ctxStatic}/spacety/js/echarts.min.js"></script>
    <script src="${ctxStatic}/spacety/js/div_resize.js"></script>
</head>
<body>
    <div class="hd-page">
        ...
        <div class="hd-bar">
            ...
            <a class="btn download" href="javascript:void(0);" onclick="download1()"><i class="g-icon"></i>下载数据</a>
    ...
    <div class="wrap-orgin">
                            ...
                            <div class="cont">
                                <div class="info-item2">
                                    ...
                                    <div class="txt" id="wdtxt">
                                        <div class="item"><i class="icon s3"></i>定位星数<span>12</span></div>
                                        <div class="item"><i class="icon s4"></i>跟踪星数<span>36</span></div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="cont">
                                <div class="info-item1">
                                    <div class="pic" style="background-image:url('${ctxStatic}/spacety/images/pic-1-1.png');"></div>
                                    <div class="txt" id="dydltxt">
                        ...
                        <li>
                            ...
                            <div class="cont">
                                <div class="info-item2">
                                    ...
                                    <div class="txt">
                                        <div class="item"><i class="icon s1"></i>经度<span>90.70 °</span></div>
                                        <div class="item"><i class="icon s2"></i>纬度<span>35.52 °</span></div>
                                        <div class="item"><i class="icon s3"></i>高度<span>513046 m</span></div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="cont">
                                <div class="info-item1 s2">
                                    <div class="pic" style="background-image:url('${ctxStatic}/spacety/images/pic-1-2.png');"></div>
                                    <div class="txt">
        ...
        <div class="wrap-aside">
            ...
            <div class="star-info">
                ...
                <div id="starInfo" class="info" style="background-image: url('${ctxStatic}/spacety/images/pic-2-1.png')">
                    <div class="item"><div class="lab">卫星名称：</div><div class="val name" id="wxmc"></div></div>
                    <div class="item"><div class="lab">轨道信息：</div><div class="val name">低轨道，高度513046m</div></div>
    ...
    <script src="${ctxStatic}/spacety/js/tools.js"></script>
    <script src="${ctxStatic}/spacety/js/index.js"></script>
...
$(function() {
	...
	$.ajax({
        ...
        success: function (data){
            if(data.code==200){
            	...
            	var wdli = "";
            	for(var i=0;i < field_en0.length;i++){
                    for(var j=0;j<1;j++){
                    	wdli += "<div class='item'><i class='icon s3'></i>"+field_cn0[i]+"<span>"+ztlist[j][field_en0[i]]+"</span></div>";
                    } 
                }
            	$("#wdtxt").html(wdli);
            }
	...
	//电压电流
	$.ajax({
        url: contextPath+"/TYSpace/ycpzb/getDydl",
        type:"post",
        dataType:"json",
        success: function (data){
            if(data.code==200){
            	var ztlist = data.hashMap.ztlist;
            	list_dydl = data.hashMap.ztlist;
            	var dydlli = "";
            	for(var i=0;i < field_en1.length;i++){
                    for(var j=0;j<1;j++){
                    	dydlli += "<div class='lab'>"+field_cn1[i]+"</div><div class='val'>"+ztlist[j][field_en1[i]]+"</div>";
                    } 
                }
            	$("#dydltxt").html(dydlli);
            }
	...
	var wdtxt = setInterval(function () {
    	...
    	for(var i=0;i < field_en0.length;i++){
            for(var j=index_wd;j<(index_wd+1);j++){
            	wdli += "<div class='item'><i class='icon s3'></i>"+field_cn0[i]+"<span>"+list_wd[j][field_en0[i]]+"</span></div>";
            } 
        }
    	$("#wdtxt").html(wdli);
	}, 1000);
	var dydl = setInterval(function () {
		if(index_dydl<(list_dydl.length-1)){
			index_dydl++;
		}else{
			clearInterval(dydl);
		}
		var dydlli = "";
    	for(var i=0;i < field_en1.length;i++){
            for(var j=index_dydl;j<(index_dydl+1);j++){
            	dydlli += "<div class='lab'>"+field_cn1[i]+"</div><div class='val'>"+list_dydl[j][field_en1[i]]+"</div>";
            } 
        }
    	$("#dydltxt").html(dydlli);
	}, 1000);
...
var field_cn0 = ['面板+X','面板-Z','面板-X'];
var field_en0 = ['vp','vq','vr'];
var field_cn1 = ['系统输入电流','系统输出电流'];
var field_en1 = ['vai','vaj'];
//获取遥测数据表
...
function download1(){
// 	var path=ctxStatic+"/download/data.rar";
// 	var wjm = "data.rar"
// 	var url="download.jsp?path="+path+"&wjm="+wjm;
 	window.open(contextPath+"/TYSpace/file/download?fileName=data.rar");
}
</script>