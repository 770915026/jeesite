...
public class ValidateCodeServlet extends HttpServlet {
	...
	public static final String MPW_CODE = "modifyPassword";
	public static final String RGR_CODE = "register";
	...
	private void createImage(HttpServletRequest request,
		...
		if(StringUtils.isNotEmpty(type)) {
			if("1".equals(type)) {
				request.getSession().setAttribute(MPW_CODE, s);
			}
			if("2".equals(type)) {
				request.getSession().setAttribute(RGR_CODE, s);
			}
		}else {
