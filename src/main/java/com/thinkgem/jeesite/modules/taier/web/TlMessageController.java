 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/taier/tlMessage")
public class TlMessageController extends BaseController {
	...
	public String form(TlMessage tlMessage, Model model) {
		if (StringUtils.isNotBlank(tlMessage.getId())){
			tlMessage = tlMessageService.getRecorderList(tlMessage);
		}
