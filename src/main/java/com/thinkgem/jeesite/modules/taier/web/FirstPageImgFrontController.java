 ...
 */
@Controller
@RequestMapping(value = "/taier/firstPageImg")
public class FirstPageImgFrontController extends BaseController {
	...
	public String save(FirstPageImg firstPageImg, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/sys/firstPageImg/?repage";
	}
