 ...
 */
@Controller
@RequestMapping(value = "/taier/activityJoin")
public class ActivityJoinFrontController extends BaseController {
	...
	@RequestMapping(value = "saveActivityJoin")
	@ResponseBody
	public MessageData saveActivityJoin(ActivityJoin activityJoin) {
		...
		activityJoin.setCreateDate(new Date());
		int joinThisActNum=activityJoinService.getNumOfJoinThisAct(activityJoin);
		if(joinThisActNum>0){
